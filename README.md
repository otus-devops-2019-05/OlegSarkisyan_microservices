...
# Выполнено ДЗ №23 - Kubernetes. Мониторинг и логирование

##  Основное ДЗ
Создали ветку kubernetes-5
Подготовили кластер из трёх нод
С помощью Helm установили прометеус
Рассмотрели уже готовые таргеты для сбора метрик
Включили метрики node-exporter в custom_values.yml
C помощью Helm установили графану
Добавили prometheus data-source  и дашборд для отслеживания ресурсов k8s
Добавили дашборды из ДЗ по мониторингу
Подключили смешанные графики
Создали файлы для EFK, запустили стек в k8s
С помощью Helm установили Кибану 
Создали шаблон индекса, посмотрели результаты вывода в Кибане
